...
async function postButtonMessage() {
  const res = await fetch(`https://discord.com/api/v10/channels/${CHANNEL_ID()}/messages`, {
    ...
    body: JSON.stringify({
      content:
        "🎟 **NFTBingo Holder Verification**\n\nClick the button below to verify your wallet and receive your holder roles. Once verified, you will have full access to the NFTBingo Discord server.\n\n📱 **Mobile tip:** If wallet connect doesn’t open, copy the URL from the browser and open it in your mobile wallet browser.\n\nIf it fails, retry immediately and it should work.",
      components: [
        {
          type: 1,
          components: [
            {
              type: 2,
              style: 1,
              label: "Verify NFTBingo Card Ownership",
