    ...
    () => [
      {
        ...
        theme: "pink",
        items: [
          { id: "p1-website", label: "Website UI/UX baseline complete", status: "in-progress" },
          { id: "p1-whitepaper", label: "Whitepaper published (web + downloadable PDF)", status: "in-progress" },
          { id: "p1-roadmap-graphic", label: "Graphical roadmap live (timeline + phases)", status: "done" },
          { id: "p1-amoy-contract", label: "Amoy test contract deployed & verified", status: "done" },
          { id: "p1-amoy-token", label: "Test token configured + faucet/test flow validated", status: "planned" },
          { id: "p1-mint-flow", label: "Mint flow working end-to-end from the website", status: "in-progress" },
          { id: "p1-metadata", label: "Metadata hosting + tokenURI reliably resolving", status: "in-progress" },
      ...
      },
      {
        ...
        theme: "indigo",
        items: [
          { id: "p2-founder-cards", label: "Founder card system rules finalized (non-pay-to-win)", status: "planned" },
          { id: "p2-founder-mint", label: "Founder mint page + supply controls", status: "planned" },
          { id: "p2-staking-model", label: "Card staking / delegated play model defined", status: "planned" },
          { id: "p2-economy-model", label: "Ecosystem economic model documented (fees, prizes, sustainability)", status: "planned" },
          { id: "p2-creator-partners", label: "Creator partnership pipeline defined (artwork → cards → rewards loop)", status: "planned" },
          { id: "p2-compliance-pass", label: "Risk & compliance considerations documented (jurisdiction approach)", status: "planned" },
        ],
      },
      {
        id: "phase-3",
        title: "Phase 3 — Polygon Launch: Token + Game Goes Live",
        subtitle:
