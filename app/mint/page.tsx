    ...
    <main className="relative min-h-screen bg-gradient-to-b from-white to-slate-100 overflow-hidden">
      ...
      <section className="max-w-5xl mx-auto py-12 px-6">
                ...
                <div className="mt-4 space-y-3 text-slate-700">
                  <div className="rounded-xl bg-slate-50 border border-slate-200 p-4">
                    <ul className="list-disc pl-5 space-y-2 text-sm">
                      <li>Player Series cards are free to mint (you only pay network fees, usually ~$2 depending on Solana network conditions).</li>
                      ...
                      <li>Your wallet will ask you to verify the transaction before sending the NFTBingo card to you. This is where the ~$2 comes from. </li>
                    </ul>
                  </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            {mode === "FOUNDERS" ? (
              ...
              <>
                ...
                <div className="mt-5 rounded-xl bg-gradient-to-r from-pink-50 via-fuchsia-50 to-indigo-50 border border-slate-200 p-4">
                  <div className="text-sm text-slate-700 space-y-2">
                    <div><span className="font-semibold">User Cost:</span> FREE + network fees</div>
                ...
                {playerLastMint?.imageUri ? (
                  ...
                  <div className="mt-6 rounded-xl border border-dashed border-slate-300 bg-slate-50 p-8 text-center text-sm text-slate-600">
                    Mint a Players Series card to preview it here.
                  </div>
                )}
              </>
            )}
        ...
        <div className="mt-10 text-xs text-slate-500 text-center">
          Founders Series cards are USD pegged to $125 at mint time, paid by the user. Irys upload and storage fees are payed by NFTBingo. Player Series cards are free to mint, but you pay the Solana network and rental fee (usually about two dollars). Prices may fluctuate based on Solana network conditions.
        </div>
      </section>
