...
For a bingo card, this information includes the exact numbers arranged in the 5 × 5 grid.
...
Once an NFTBingo card is minted, its metadata does not change.
...
Because the card’s data is embedded in the NFT, results can always be reviewed and verified.
